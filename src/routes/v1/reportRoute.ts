...
router.get('/promo/summary', protect(), reportController.getReportPromoSummary);
router.get('/promo/summary/excel', protect(), reportController.genExcelReportPromoSummary);
