...
CREATE INDEX idx_osl_leads_closing_no_kontrak ON public.leads_closing_osl USING btree (no_kontrak);
CREATE INDEX idx_osl_leads_closing_osl_osl_no_kontrak ON public.leads_closing_osl USING btree (no_kontrak);
CREATE INDEX idx_osl_leads_closong_osl_tgl_kredit ON public.leads_closing_osl USING btree (tgl_kredit DESC);